/*
 * Created by JFormDesigner on Fri Jul 02 00:16:36 IRDT 2021
 */
...
public class RemovePersonnelPanel extends JFrame {
    ...
    {
        initComponents();
        for (person p : trainStation.currentTrainStation.getVehicleLeader())
            personnelCMB.addItem(p);
        for (person p : trainStation.currentTrainStation.getEmployee())
            personnelCMB.addItem(p);
    ...
    private void DeleteBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground() {
                ...
                trainStation.currentTrainStation.removePersonnel(p);
            ...
            panel1Layout.setHorizontalGroup(
                panel1Layout.createParallelGroup()
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 673, Short.MAX_VALUE)
                        ...
                        .addGroup(citiesContainerLayout.createParallelGroup()
                            .addGroup(citiesContainerLayout.createSequentialGroup()
                                ...
                                .addGroup(citiesContainerLayout.createParallelGroup()
                                    ...
                                    .addComponent(personnelCMB, GroupLayout.PREFERRED_SIZE, 511, GroupLayout.PREFERRED_SIZE)))
                            .addGroup(citiesContainerLayout.createSequentialGroup()
                                .addGap(49, 49, 49)
                                .addComponent(DeleteBTN, GroupLayout.PREFERRED_SIZE, 393, GroupLayout.PREFERRED_SIZE)))
