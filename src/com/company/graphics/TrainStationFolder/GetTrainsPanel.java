/*
 * Created by JFormDesigner on Wed Jun 30 17:56:51 IRDT 2021
 */
 ...
 * @author pouria
 */
public class GetTrainsPanel extends JFrame {
    public GetTrainsPanel()
    {
        initComponents();
        trainStation.currentTrainStation.getVehicleList().forEach(vehicle -> vehicle.createVehicleBTN(vehiclePanel,this));
        ...
        contentPaneLayout.setVerticalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(vehiclePanel, GroupLayout.DEFAULT_SIZE, 660, Short.MAX_VALUE))
        );
        setSize(935, 760);
