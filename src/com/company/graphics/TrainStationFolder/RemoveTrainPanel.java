/*
 * Created by JFormDesigner on Wed Jun 30 10:46:37 IRDT 2021
 */
...
public class RemoveTrainPanel extends JFrame {
    public RemoveTrainPanel()
    {
        initComponents();
        trainStation.currentTrainStation.getVehicleList().forEach(vehicle -> vehicle.createRemoveBTN(vehiclePanel,this));
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Remove Train Menu");
        ...
        contentPaneLayout.setVerticalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(vehiclePanel, GroupLayout.PREFERRED_SIZE, 599, GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        setSize(935, 625);
