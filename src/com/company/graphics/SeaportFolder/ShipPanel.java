/*
 * Created by JFormDesigner on Wed Jun 30 17:23:38 IRDT 2021
 */
 ...
 * @author pouria
 */
public class ShipPanel extends JFrame {
    public ShipPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Ship Information");
        ...
        //======== panel2 ========
        {
            ...
            label3.setIcon(new ImageIcon(getClass().getResource("/icons/cruise.png")));
            ...
            //---- fuelLBL ----
            fuelLBL.setText("text");
            fuelLBL.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            fuelLBL.setForeground(Color.white);

            //---- label10 ----
            label10.setText("Fuel");
            label10.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            label10.setForeground(Color.white);
            label10.setIcon(new ImageIcon(getClass().getResource("/icons/gas-station.png")));
                            ...
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup()
                                    .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(label5, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                                        .addComponent(label6, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE))
                                    .addComponent(label7)
                        ...
                        .addGroup(panel2Layout.createParallelGroup()
                            ...
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup()
                                    ...
                                    .addComponent(fuelLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(companyLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 378, Short.MAX_VALUE)))
                        .addContainerGap())
                    .addGroup(GroupLayout.Alignment.TRAILING, panel2Layout.createSequentialGroup()
                        .addContainerGap(291, Short.MAX_VALUE)
                        .addComponent(okBTN, GroupLayout.PREFERRED_SIZE, 352, GroupLayout.PREFERRED_SIZE)
                        .addGap(280, 280, 280))
            );
                ...
                panel2Layout.createParallelGroup()
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(fuelLBL, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
