/*
 * Created by JFormDesigner on Wed Jun 30 10:40:30 IRDT 2021
 */
 ...
 * @author pouria
 */
public class RemoveMarineVehiclePanel extends JFrame {
    public RemoveMarineVehiclePanel()
    {
        initComponents();
        seaPort.currentSeaport.getVehicleList().forEach(vehicle -> vehicle.createRemoveBTN(vehiclePanel,this));
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Remove Marine Vehicle  Menu");
