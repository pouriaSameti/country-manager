/*
 * Created by JFormDesigner on Mon Jun 28 22:35:38 IRDT 2021
 */
 ...
 * @author pouria
 */
public class CreateBankPanel extends JFrame {
    public CreateBankPanel()
    {
        initComponents();
    ...
    private void saveBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground()
            {
                ...
                Bank bank = new Bank(name,City, country,address) ;
                String message =  "Bank " + bank.getBankName() + " was created" ;
                String title = "Create Bank" ;
                ImageIcon icon = new ImageIcon("src\\icons\\banking.png") ;
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Create Bank Menu");
