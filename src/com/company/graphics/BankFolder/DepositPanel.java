/*
 * Created by JFormDesigner on Sat Jul 03 22:28:10 IRDT 2021
 */
...
public class DepositPanel extends JFrame {
    ...
    private void depositBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground() {
                ...
                Account.currentAccount.depositToAccount(amount);
                Account.currentAccount.updateAccountPanel();
                Bank.currentBank.updateBankPanel();
                String message = "Money was Deposited" ;
    ...
    private void initComponents() {
        ...
        //======== panel3 ========
        {
            ...
            //---- label8 ----
            label8.setText("Deposit Money Menu");
        ...
        //======== panel4 ========
        {
            ...
            depositBTN.setBackground(new Color(0, 0, 102));
                ...
                panel4Layout.createParallelGroup()
                    .addGroup(panel4Layout.createSequentialGroup()
                        ...
                        .addGroup(panel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panel4Layout.createSequentialGroup()
                                .addComponent(depositBTN, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
