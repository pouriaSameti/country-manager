/*
 * Created by JFormDesigner on Wed Jun 30 17:09:47 IRDT 2021
 */
...
public class BusPanel extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Bus Information");
        ...
        //======== panel2 ========
        {
            ...
            label3.setIcon(new ImageIcon(getClass().getResource("/icons/bus.png")));
                                ...
                                .addGroup(panel2Layout.createParallelGroup()
                                    ...
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        .addGroup(panel2Layout.createParallelGroup()
                                            ...
                                            .addComponent(colorLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE)
                                            .addComponent(companyLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE))
                                        .addGap(0, 383, Short.MAX_VALUE)))))
                        .addContainerGap())
                    .addGroup(GroupLayout.Alignment.TRAILING, panel2Layout.createSequentialGroup()
                        .addContainerGap(300, Short.MAX_VALUE)
                        .addComponent(okBTN, GroupLayout.PREFERRED_SIZE, 341, GroupLayout.PREFERRED_SIZE)
                        .addGap(287, 287, 287))
            );
