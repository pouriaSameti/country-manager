/*
 * Created by JFormDesigner on Thu Jul 01 23:59:59 IRDT 2021
 */
...
public class RemovePersonnelPanel extends JFrame {
    ...
    {
        initComponents();
        for (person p : busTerminal.currentBusTerminal.getVehicleLeader())
            personnelCMB.addItem(p);
        for (person p : busTerminal.currentBusTerminal.getEmployee())
            personnelCMB.addItem(p);
    ...
    private void DeleteBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground() {
                ...
                busTerminal.currentBusTerminal.removePersonnel(p);
                ...
                citiesContainerLayout.createParallelGroup()
                    .addGroup(citiesContainerLayout.createSequentialGroup()
                        ...
                        .addGroup(citiesContainerLayout.createParallelGroup()
                            ...
                            .addComponent(personnelCMB, GroupLayout.PREFERRED_SIZE, 518, GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(199, Short.MAX_VALUE))
                    .addGroup(GroupLayout.Alignment.TRAILING, citiesContainerLayout.createSequentialGroup()
                        .addContainerGap(302, Short.MAX_VALUE)
                        .addComponent(DeleteBTN, GroupLayout.PREFERRED_SIZE, 336, GroupLayout.PREFERRED_SIZE)
                        .addGap(300, 300, 300))
            );
        ...
        contentPaneLayout.setVerticalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(citiesContainer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
