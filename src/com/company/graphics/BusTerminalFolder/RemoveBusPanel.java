/*
 * Created by JFormDesigner on Wed Jun 30 10:27:13 IRDT 2021
 */
 ...
 * @author pouria
 */
public class RemoveBusPanel extends JFrame {
    public RemoveBusPanel() 
    {
        initComponents();
        busTerminal.currentBusTerminal.getVehicleList().forEach(vehicle -> vehicle.createRemoveBTN(vehiclePanel,this));
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Remove Bus Menu");
