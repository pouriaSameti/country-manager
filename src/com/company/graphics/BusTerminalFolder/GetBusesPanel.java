/*
 * Created by JFormDesigner on Wed Jun 30 17:06:33 IRDT 2021
 */
 ...
 * @author pouria
 */
public class GetBusesPanel extends JFrame {
    public GetBusesPanel() {
        initComponents();
        busTerminal.currentBusTerminal.getVehicleList().forEach(vehicle -> vehicle.createVehicleBTN(vehiclePanel,this));
