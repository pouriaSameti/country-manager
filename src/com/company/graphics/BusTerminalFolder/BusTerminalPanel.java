/*
 * Created by JFormDesigner on Tue Jun 29 18:13:16 IRDT 2021
 */
 ...
 * @author pouria
 */
public class BusTerminalPanel extends JFrame {
    ...
    private void removeVehicleBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground()
            {
                RemoveBusPanel rbp = new RemoveBusPanel() ;
                rbp.setVisible(true);
                return null ;
            }
        }.execute();
    ...
    private void getVehicleBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            @Override
            public Object doInBackground() {
                GetBusesPanel gbp = new GetBusesPanel() ;
                gbp.setVisible(true);
                return null ;
            }
        }.execute();
    ...
    private void addPersonnelBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground() {
                try {
                    busTerminal.currentBusTerminal.checkPersonJob();
                    busTerminal.currentBusTerminal.hireJob();
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Bus Terminal  Menu");
        ...
        //======== panel2 ========
        {
            ...
            getVehicleBTN.setIcon(new ImageIcon(getClass().getResource("/icons/bus.png")));
            ...
            label3.setIcon(new ImageIcon(getClass().getResource("/icons/bus terminal icon.png")));
            ...
            label6.setIcon(new ImageIcon(getClass().getResource("/icons/bus.png")));
                    ...
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup()
                            .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(panel2Layout.createSequentialGroup()
                                    .addComponent(removeVehicleBTN, GroupLayout.PREFERRED_SIZE, 240, GroupLayout.PREFERRED_SIZE)
                                    .addGap(55, 55, 55)
                                    .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(addVehicleBTN, GroupLayout.PREFERRED_SIZE, 240, GroupLayout.PREFERRED_SIZE))
                        .addGap(51, 51, 51)
                        .addGroup(panel2Layout.createParallelGroup()
                            .addComponent(getVehicleBTN, GroupLayout.PREFERRED_SIZE, 240, GroupLayout.PREFERRED_SIZE)
                            .addComponent(getPersonnelBTN, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
