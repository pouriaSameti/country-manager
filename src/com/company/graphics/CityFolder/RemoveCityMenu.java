/*
 * Created by JFormDesigner on Mon Jun 28 15:49:32 IRDT 2021
 */
 ...
 * @author pouria
 */
public class RemoveCityMenu extends JFrame implements Serializable
{
    public RemoveCityMenu()
    {
        initComponents();
    ...
    private void selectBTNActionPerformed(ActionEvent e) {
        ...
        new SwingWorker<>(){
            ...
            public Object doInBackground() {
                ...
                Country.getCountry().removeCity(c);
    ...
    private void initComponents()
    {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Remove City Menu");
        ...
        //======== citiesContainer ========
        {
            ...
            //---- selectBTN ----
            selectBTN.setText("Delete");
            selectBTN.setBackground(new Color(0, 51, 51));
            ...
            selectBTN.setIcon(new ImageIcon(getClass().getResource("/icons/remove building.png")));
                ...
                citiesContainerLayout.createParallelGroup()
                    ...
                    .addGroup(citiesContainerLayout.createSequentialGroup()
                        ...
                        .addGroup(citiesContainerLayout.createParallelGroup()
                            ...
                            .addGroup(citiesContainerLayout.createSequentialGroup()
                                .addComponent(cityCMB, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
                                .addGap(235, 235, 235))))
            );
