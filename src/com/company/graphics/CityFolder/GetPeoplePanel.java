/*
 * Created by JFormDesigner on Thu Jul 01 17:24:03 IRDT 2021
 */
 ...
 * @author pouria
 */
public class GetPeoplePanel extends JFrame {
    public GetPeoplePanel() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Get People Menu");
            ...
            citiesContainerLayout.setHorizontalGroup(
                citiesContainerLayout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, citiesContainerLayout.createSequentialGroup()
                        ...
                        .addComponent(peopleCMB, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
                        .addGap(235, 235, 235))
                    .addGroup(GroupLayout.Alignment.TRAILING, citiesContainerLayout.createSequentialGroup()
