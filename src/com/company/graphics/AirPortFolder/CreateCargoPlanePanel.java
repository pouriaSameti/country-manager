/*
 * Created by JFormDesigner on Wed Jun 30 00:45:33 IRDT 2021
 */
...
import com.company.Vehicle.cargoPlane ;
import com.company.country.Country;

/**
 * @author pouria
 */
public class CreateCargoPlanePanel extends JFrame {
    public CreateCargoPlanePanel()
    {
        initComponents();
            ...
            public Object doInBackground()
            {
                ...
                else
                {
                    try {
                        ...
                        int loadWeight = (int) setLoadWeightSPN.getValue() ;
                        int maxVolume = (int) setMaxVolumeSPN.getValue() ;
                        cargoPlane cp = new cargoPlane(name,loadWeight,maxVolume) ;
                        airPort.currentAirport.addVehicle(cp);
                        String message = cp.getName() + " was created" ;
                        String title = "Create Cargo Plane" ;
                        ImageIcon icon = new ImageIcon("src\\icons\\cargo plane.png") ;
                        JOptionPane.showMessageDialog(null,message,title,JOptionPane.ERROR_MESSAGE,icon);
                        airPort.currentAirport.updateAirportPanel();
                        airPort.currentAirport.getCity().setFinallyBudget();
    ...
    private void initComponents() {
        ...
        label4 = new JLabel();
        label5 = new JLabel();
        setLoadWeightSPN = new JSpinner();
        setMaxVolumeSPN = new JSpinner();
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Create Cargo Plane Menu");
        ...
        //======== panel2 ========
        {
            ...
            //---- setLoadWeightSPN ----
            setLoadWeightSPN.setModel(new SpinnerNumberModel(1, 1, null, 1));
            setLoadWeightSPN.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));

            //---- setMaxVolumeSPN ----
            setMaxVolumeSPN.setModel(new SpinnerNumberModel(1, 1, 70, 1));
            setMaxVolumeSPN.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                    ...
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup()
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup()
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        .addComponent(label3, GroupLayout.PREFERRED_SIZE, 133, GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(nameTXT, GroupLayout.DEFAULT_SIZE, 566, Short.MAX_VALUE)
                                        .addGap(12, 12, 12))
                                    .addGroup(panel2Layout.createSequentialGroup()
                            ...
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(setMaxVolumeSPN, GroupLayout.PREFERRED_SIZE, 218, GroupLayout.PREFERRED_SIZE))
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        .addComponent(label4, GroupLayout.PREFERRED_SIZE, 133, GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(setLoadWeightSPN)))
                ...
                panel2Layout.createParallelGroup()
                    .addGroup(GroupLayout.Alignment.TRAILING, panel2Layout.createSequentialGroup()
                        ...
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(setLoadWeightSPN, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addGap(28, 28, 28)
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(label5, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
                            .addComponent(setMaxVolumeSPN, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
    ...
    private JSpinner setLoadWeightSPN;
    private JSpinner setMaxVolumeSPN;
