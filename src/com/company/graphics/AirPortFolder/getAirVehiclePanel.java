/*
 * Created by JFormDesigner on Wed Jun 30 16:19:02 IRDT 2021
 */
 ...
 * @author pouria
 */
public class getAirVehiclePanel extends JFrame {
    public getAirVehiclePanel()
    {
        initComponents();
        airPort.currentAirport.getVehicleList().forEach(vehicle -> vehicle.createVehicleBTN(vehiclePanel,this));
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Air Vehicle  Menu");
        ...
        contentPaneLayout.setVerticalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(vehiclePanel, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE))
        );
        setSize(940, 600);
