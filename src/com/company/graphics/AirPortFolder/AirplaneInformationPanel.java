/*
 * Created by JFormDesigner on Wed Jun 30 15:40:47 IRDT 2021
 */
 ...
 * @author pouria
 */
public class AirplaneInformationPanel extends JFrame {
    public AirplaneInformationPanel()
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- label1 ----
            label1.setText("Airliner Information");
        ...
        //======== panel2 ========
        {
            ...
            label3.setIcon(new ImageIcon(getClass().getResource("/icons/airplane.png")));
            ...
            //---- label6 ----
            label6.setText("Max Altitude");
            label6.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            label6.setForeground(Color.white);
            label6.setIcon(new ImageIcon(getClass().getResource("/icons/altitude 2.png")));
            ...
            altitudeLBL.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            altitudeLBL.setForeground(Color.white);
            ...
            //---- crewLBL ----
            crewLBL.setText("text");
            crewLBL.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            crewLBL.setForeground(Color.white);

            //---- label10 ----
            label10.setText("Crew");
            label10.setFont(new Font("Myanmar Text", Font.PLAIN, 20));
            label10.setForeground(Color.white);
            label10.setIcon(new ImageIcon(getClass().getResource("/icons/crew.png")));
                        ...
                        .addGroup(panel2Layout.createParallelGroup()
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(label8, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(panel2Layout.createParallelGroup()
                                    ...
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        .addGroup(panel2Layout.createParallelGroup()
                                            ...
                                            .addComponent(altitudeLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(panel2Layout.createSequentialGroup()
                                .addGroup(panel2Layout.createParallelGroup()
                                    .addGroup(panel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(crewLBL, GroupLayout.PREFERRED_SIZE, 346, GroupLayout.PREFERRED_SIZE))
                                    .addGroup(panel2Layout.createSequentialGroup()
            ...
            panel2Layout.setVerticalGroup(
                panel2Layout.createParallelGroup()
                    .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            .addComponent(altitudeLBL, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(crewLBL, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE))
